...
<div class="container">
            ...
            <form action="/cadastrarfuncionario" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="login">Login do Cliente</label>
                            <input type="text" id="login" name="login" class="form-control {{ $errors->has('login') ? 'is-invalid' : '' }}" placeholder="Login do cliente">
                        @if($errors->has('login'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="senha" name="senha" class="form-control {{ $errors->has('senha') ? 'is-invalid' : '' }}" placeholder="Senha do cliente">
                            @if($errors->has('senha'))
